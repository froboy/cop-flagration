...
export function calculateDeploymentCost(params: DeploymentCostInput) {
  ...
  return (
    params.officerCount * params.costPerOfficerPerHour * hours +
    params.commanderCount * params.costPerCommanderPerHour * hours +
    params.vehicleCount * params.costPerVehiclePerHour * hours +
    params.helicopterCount * params.costPerHelicopterPerHour * hours +
    params.motorcycleCount * params.costPerMotorcyclePerHour * hours
  );
}
