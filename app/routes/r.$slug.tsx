...
export default function ReportSharePage() {
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-8">
      <p className="text-sm uppercase tracking-wide text-zinc-500">Shared report</p>
      ...
      <section className="mt-6 rounded-2xl border border-zinc-200 bg-white p-5">
        <p className="text-xs uppercase tracking-wide text-zinc-500">estimated cost to the community</p>
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        ...
        <Link to="/report/new" className="rounded-lg bg-zinc-900 px-4 py-2 text-sm font-semibold text-white">
          Document another →
        </Link>
      </div>
