  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-10">
      <section className="rounded-2xl border border-zinc-300 bg-white p-6 shadow-sm">
        ...
        <a
          href="/report/new"
          className="mt-6 inline-flex rounded-xl bg-zinc-900 px-5 py-3 text-lg font-black text-white"
        >
          Document a cop-flagration →
        </a>
        <div className="mt-4 flex gap-4 text-sm">
          <a href="/about" className="font-semibold text-zinc-700 underline">
            About
          </a>
          <a href="/cities" className="font-semibold text-zinc-700 underline">
            Cities
          </a>
        </div>
      </section>
