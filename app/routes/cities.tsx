    ...
    <main className="mx-auto max-w-6xl px-4 py-8">
      ...
      <div className="mt-5 overflow-x-auto rounded-2xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
        <table className="min-w-full text-left text-sm">
          <thead className="bg-zinc-100 text-xs uppercase tracking-wide text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300">
            <tr>
          ...
          <tbody>
            {cities.map((city) => (
              <tr key={city.id} className="border-t border-zinc-200 dark:border-zinc-800">
